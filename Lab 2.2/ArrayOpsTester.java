public class ArrayOpsTester {
    public static void main(String[] args) {
        ...
        System.out.println(ArrayOps.printStringArray(stringArr1)); // Output: [apple, banana, kiwi, orange]

        String[] stringArr2 = { "cat", "dog", "elephant", "lion" };
        System.out.println(ArrayOps.printStringArray(stringArr2)); // Output: [cat, dog, elephant, lion]

        String[] stringArr3 = { "red", "green", "blue", "yellow" };
        System.out.println(ArrayOps.printStringArray(stringArr3)); // Output: [red, green, blue, yellow]
